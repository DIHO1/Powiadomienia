...
const config = {
  ...
  defaultConfig: [
    ...
    {
      type: "textbox",
      name: " Powiadomienia o słowach kluczowych",
    ...
    {
      type: "switch",
      name: "Wyłącz DMs powiadomienia!",
      note: "Nie wysyłaj powiadomień DM!.",
      id: "ignoreDMs",
      value: false,
    },
    {
    ...
    },
    {
      ...
      note: "Nie wysylaj powiadomięn grupowych.",
      id: "ignoreDMGroups",
      value: false,
    },
    {
  ...
  ? class {
      ...
      load() {
        BdApi.showConfirmationModal(
          "Biblioteka pluginu jest potrzebna!",
          `Brakuje wtyczki biblioteki wymaganej dla DIHO PLugin. Kliknij Pobierz teraz, aby go zainstalować.`,
          {
            confirmText: "Pobierz",
            cancelText: "Anuluj",
            onConfirm: () => {
